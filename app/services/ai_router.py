...
class AiRouter:
    ...
    async def classify_light_intent(self, *, text: str) -> AiJsonResult:
        ...
        prompt = (
            ...
            "Gas, Tolls, Public Transport, Sport, Entertainment, Health, Beauty, House Chemicals, "
            "Subscriptions, Taxes, Utilities, Other, Income. Use Uber/Gas/Tolls/Public Transport for commute details.\n"
    ...
    async def _gemini_bank_json(self, *, image_bytes: bytes, mime_type: str) -> AiJsonResult:
        ...
        prompt = (
            ...
            "Uber, Gas, Tolls, Public Transport, Sport, Entertainment, Health, Beauty, House Chemicals, "
            "Subscriptions, Taxes, Utilities, Income, Other. Use Uber/Gas/Tolls/Public Transport instead "
            "of a generic Commute category. PayPal ride/transport bills should be Uber."
        )
        url = (
            "https://generativelanguage.googleapis.com/v1beta/models/"
            f"{self.settings.gemini_model}:generateContent"
