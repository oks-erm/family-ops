...
:root{font-family:"Google Sans",Inter,ui-sans-serif,system-ui,-apple-system,sans-serif;color:#29213a;background:#f8f6fc;--purple:#7357c7;--purple-dark:#6042b3;--purple-soft:#f0ebfc;--surface:#faf9fe;--line:#e5deef;--muted:#756d82}*{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:clamp(18px,4vw,48px);background:radial-gradient(circle at 12% 6%,#ede8ff 0,transparent 32%),radial-gradient(circle at 90% 10%,#f7ebfa 0,transparent 28%),#f8f6fc}.shell{width:min(1100px,100%);background:rgba(255,255,255,.97);border:1px solid rgba(221,212,235,.92);border-radius:26px;box-shadow:0 22px 60px rgba(67,47,98,.11);overflow:hidden;backdrop-filter:blur(12px)}.page-header{padding:28px 34px;border-bottom:1px solid #eee9f4}h1{font-size:clamp(25px,3vw,30px);line-height:1.2;letter-spacing:-.025em;margin:0}h2{font-size:17px;line-height:1.3;letter-spacing:-.015em;margin:0}h3{font-size:15px;line-height:1.35;margin:0}.booking-layout{display:grid;grid-template-columns:260px minmax(0,1fr);min-height:470px}.lesson-panel{padding:30px 26px;border-right:1px solid #eee9f4;background:linear-gradient(180deg,#fcfbff,#faf8fe)}.step-heading{display:flex;align-items:center;gap:10px;margin-bottom:18px}.step-number{width:28px;height:28px;display:grid;place-items:center;flex:0 0 auto;border-radius:10px;background:var(--purple-soft);color:var(--purple-dark);font-size:13px;font-weight:800}.types{display:grid;gap:10px}.type-choice{width:100%;text-align:left;min-height:44px;border:1px solid #ded5e9;background:#fff;color:#4e3d68;border-radius:13px;padding:11px 13px;cursor:pointer;font-weight:700;font-size:13px;transition:.14s}.type-choice.active,.type-choice:hover{background:var(--purple-soft);border-color:#cfc0ed;color:var(--purple-dark);box-shadow:0 5px 14px rgba(96,66,179,.1)}.scheduler{padding:30px 32px}.calendar-layout{display:grid;grid-template-columns:minmax(330px,1fr) 220px;gap:28px}.calendar-panel{min-width:0}.calendar-toolbar{display:flex;align-items:center;justify-content:space-between;margin-bottom:18px}.calendar-nav{display:flex;gap:7px}.icon-button{width:36px;height:36px;border:1px solid var(--line);border-radius:50%;background:#fff;color:#4e3d68;display:grid;place-items:center;cursor:pointer;font-size:20px;line-height:1}.icon-button:hover:not(:disabled){background:var(--purple-soft);border-color:#d4c7eb}.icon-button:disabled{opacity:.3;cursor:default}.calendar{display:grid;grid-template-columns:repeat(7,minmax(36px,1fr));gap:6px}.weekday{text-align:center;color:#8a8295;font-size:11px;font-weight:750;text-transform:uppercase;padding:6px 0}.calendar-blank{aspect-ratio:1}.day{width:100%;aspect-ratio:1;border:0;border-radius:50%;background:transparent;color:#9a93a4;font-size:13px;font-weight:650;cursor:default}.day.available{background:#f2edfc;color:#4f3b71;cursor:pointer}.day.available:hover{background:#e4daf8;color:var(--purple-dark)}.day.selected{background:var(--purple);color:#fff;box-shadow:0 5px 14px rgba(96,66,179,.24)}.day.today:not(.selected){box-shadow:inset 0 0 0 1px #bba9df}.time-panel{border-left:1px solid #eee9f4;padding-left:24px;min-width:0}.time-panel .muted{font-size:12px;margin:6px 0 18px}.time-slots{display:grid;gap:8px;max-height:350px;overflow:auto;padding-right:4px}.time-placeholder{color:#8a8295;font-size:13px;line-height:1.5;padding:12px 0}.time-choice{width:100%;min-height:40px;border:1px solid #d9cee8;background:#fff;color:#4e3d68;border-radius:11px;padding:9px 12px;cursor:pointer;font-size:13px;font-weight:750;transition:.14s}.time-choice:hover,.time-choice.active{background:var(--purple);border-color:var(--purple);color:#fff;box-shadow:0 5px 14px rgba(96,66,179,.18)}.details{margin-top:26px;border-top:1px solid #eee9f4;padding-top:24px}.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:0 14px}.form-grid .full{grid-column:1/-1}label{display:grid;gap:7px;margin:12px 0;font-weight:650;font-size:13px}input,textarea,button{font:inherit}input,textarea{min-height:44px;padding:10px 12px;border:1px solid #d8cfe4;border-radius:11px;outline:none;background:#fff}textarea{min-height:82px;resize:vertical}input:focus,textarea:focus{border-color:var(--purple);box-shadow:0 0 0 3px rgba(115,87,199,.14)}button.primary{min-height:42px;border:0;background:var(--purple);color:#fff;padding:10px 18px;border-radius:11px;font-weight:750;cursor:pointer;box-shadow:0 6px 16px rgba(96,66,179,.18)}button.primary:hover{background:var(--purple-dark)}.hidden{display:none}.error{color:#a6404a;margin:14px 0 0;font-size:13px}.success{margin:30px;padding:22px;background:var(--purple-soft);border:1px solid #ded4f4;border-radius:16px}.hp{position:absolute;left:-9999px}@media(max-width:900px){body{place-items:start center}.booking-layout{grid-template-columns:1fr}.lesson-panel{border-right:0;border-bottom:1px solid #eee9f4;padding:22px 26px}.types{display:flex;flex-wrap:wrap}.type-choice{width:auto}.scheduler{padding:26px}.calendar-layout{grid-template-columns:minmax(300px,1fr) 200px;gap:22px}.time-panel{padding-left:20px}}@media(max-width:650px){body{padding:0}.shell{border-radius:0;border-left:0;border-right:0;min-height:100vh}.page-header{padding:22px}.scheduler{padding:22px}.calendar-layout{grid-template-columns:1fr}.time-panel{border-left:0;border-top:1px solid #eee9f4;padding:20px 0 0}.time-slots{grid-template-columns:repeat(2,1fr);max-height:none}.form-grid{grid-template-columns:1fr}.form-grid .full{grid-column:auto}}
</style></head><body><main class="shell"><header class="page-header"><h1 id="title">Book a lesson</h1></header><div id="app" class="booking-layout"><aside class="lesson-panel"><div class="step-heading"><span class="step-number">1</span><h2>Choose a lesson</h2></div><div class="types" id="types"></div></aside><section class="scheduler"><div class="step-heading"><span class="step-number">2</span><h2>Choose a date and time</h2></div><div class="calendar-layout"><div class="calendar-panel"><div class="calendar-toolbar"><h2 id="month-label">Select a lesson</h2><div class="calendar-nav"><button class="icon-button" id="previous-month" type="button" aria-label="Previous month">‹</button><button class="icon-button" id="next-month" type="button" aria-label="Next month">›</button></div></div><div class="calendar" id="calendar"></div></div><aside class="time-panel"><h3 id="selected-date">Select a date</h3><p class="muted" id="tz"></p><div class="time-slots" id="slots"><p class="time-placeholder">Choose a lesson to view available dates.</p></div></aside></div><form id="booking" class="details hidden"><h2>Your details</h2><div class="form-grid"><label>Name<input name="student_name" required maxlength="255"></label><label>Email<input name="student_email" type="email" required maxlength="320"></label><label class="full">Anything I should know?<textarea name="notes" maxlength="2000"></textarea></label></div><label class="hp">Website<input name="website" tabindex="-1" autocomplete="off"></label><button class="primary">Confirm lesson</button></form><p id="error" class="error"></p></section></div><div id="success" class="success hidden"></div></main>
<script>
