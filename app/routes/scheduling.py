...
main{max-width:1440px;margin:auto;padding:36px 28px 88px}header{display:grid;grid-template-columns:minmax(300px,1fr) auto 290px;gap:20px;align-items:center;margin-bottom:26px}.header-actions{grid-column:2;display:flex;align-items:center;gap:16px}.dashboard-support{display:flex;align-items:center;gap:14px}.dashboard-support .bug-link,.admin-link{color:var(--purple-dark);font-size:13px;font-weight:750;text-decoration:none}.dashboard-support .bug-link:hover,.admin-link:hover{text-decoration:underline}.admin-link{white-space:nowrap}
...
@media(max-width:1100px){header{display:flex;align-items:flex-start;flex-direction:column;padding-right:280px}.header-actions{flex-wrap:wrap}}
@media(max-width:680px){main{padding:22px 14px 60px}header{padding-right:0}.header-actions,.dashboard-support{align-items:flex-start;flex-direction:column}.grid{grid-template-columns:1fr;gap:14px}.card{padding:20px;border-radius:18px}.days{grid-template-columns:minmax(0,1fr) minmax(0,1fr) auto}.overview{grid-template-columns:1fr}.tabs{display:flex}.tab{flex:1;min-width:0;padding-inline:10px}.student-tools{align-items:stretch;flex-direction:column}.package-row{grid-template-columns:1fr 1fr}.package-row:before{grid-column:1/-1}.confirm-actions{flex-direction:column-reverse}.confirm-actions button{width:100%}}
</style></head><body><main><header><h1>Lesson scheduling</h1><div class="header-actions"><div class="dashboard-support"><script type="text/javascript" src="https://cdnjs.buymeacoffee.com/1.0.0/button.prod.min.js" data-name="bmc-button" data-slug="okserm" data-color="#FFDD00" data-emoji="☕" data-font="Cookie" data-text="Buy me a coffee" data-outline-color="#000000" data-font-color="#000000" data-coffee-color="#ffffff"></script><a class="bug-link" href="/schedule/feedback">Report a bug</a></div>__ADMIN_LINK__</div></header><nav class="tabs" aria-label="Dashboard sections"><button class="tab active" type="button" data-tab="lessons">Lessons</button><button class="tab" type="button" data-tab="settings">Settings</button></nav>
