...
:root{font-family:"Google Sans",Inter,ui-sans-serif,system-ui,-apple-system,sans-serif;color:#29213a;background:#f8f6fc;--purple:#7357c7;--purple-dark:#6042b3;--purple-soft:#f0ebfc;--surface:#faf9fe;--line:#e5deef;--muted:#756d82}*{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:clamp(16px,4vw,40px);background:radial-gradient(circle at 12% 6%,#ede8ff 0,transparent 32%),radial-gradient(circle at 90% 10%,#f7ebfa 0,transparent 28%),#f8f6fc}.shell{width:min(760px,100%);background:rgba(255,255,255,.96);border:1px solid rgba(221,212,235,.92);border-radius:24px;padding:clamp(24px,4vw,36px);box-shadow:0 18px 48px rgba(67,47,98,.1);backdrop-filter:blur(12px)}.page-header{padding:0 2px 22px;border-bottom:1px solid #eee9f4;margin-bottom:20px}h1{font-size:clamp(25px,3vw,29px);line-height:1.2;letter-spacing:-.025em;margin:0}h2{font-size:17px;line-height:1.3;letter-spacing:-.015em;margin:0}.steps{display:grid;grid-template-columns:minmax(0,.9fr) minmax(0,1.1fr);gap:14px;align-items:start}.step{min-height:144px;background:var(--surface);border:1px solid #ece6f3;border-radius:18px;padding:18px}.step-title{display:flex;align-items:center;gap:10px;margin-bottom:14px}.step-number{width:28px;height:28px;display:grid;place-items:center;flex:0 0 auto;border-radius:10px;background:var(--purple-soft);color:var(--purple-dark);font-size:13px;font-weight:800}.muted{color:var(--muted);line-height:1.45}.step .muted{font-size:12px;margin:0 0 12px}.types,.slots{display:flex;gap:8px;flex-wrap:wrap}.slots:empty::before{content:"Select a lesson to see available times";color:#8a8295;font-size:13px;line-height:1.45}.choice{min-height:38px;border:1px solid #ded5e9;background:#fff;color:#4e3d68;border-radius:12px;padding:8px 12px;cursor:pointer;font-weight:700;font-size:13px;transition:background .14s,color .14s,border-color .14s,transform .14s,box-shadow .14s}.choice.active,.choice:hover{background:var(--purple);color:white;border-color:var(--purple);transform:translateY(-1px);box-shadow:0 5px 14px rgba(96,66,179,.16)}form{grid-column:1/-1;background:var(--surface);border:1px solid #ece6f3;border-radius:18px;padding:18px}label{display:grid;gap:7px;margin:14px 0;font-weight:650;font-size:14px}input,textarea,button{font:inherit}input,textarea{min-height:44px;padding:10px 12px;border:1px solid #d8cfe4;border-radius:12px;outline:none;background:#fff}textarea{min-height:92px;resize:vertical}input:focus,textarea:focus{border-color:var(--purple);box-shadow:0 0 0 3px rgba(115,87,199,.14)}button.primary{min-height:42px;border:0;background:var(--purple);color:#fff;padding:10px 18px;border-radius:12px;font-weight:750;cursor:pointer;box-shadow:0 6px 16px rgba(96,66,179,.18)}button.primary:hover{background:var(--purple-dark)}.hidden{display:none}.error{grid-column:1/-1;color:#a6404a;margin:0}.success{padding:20px;background:var(--purple-soft);border:1px solid #ded4f4;border-radius:16px}.hp{position:absolute;left:-9999px}@media(max-width:640px){body{place-items:start center}.shell{border-radius:20px;padding:22px}.page-header{padding-bottom:18px;margin-bottom:16px}.steps{grid-template-columns:1fr}.step{min-height:0}}
</style></head><body><main class="shell"><header class="page-header"><h1 id="title">Book a lesson</h1></header><div id="app" class="steps"><section class="step"><div class="step-title"><span class="step-number">1</span><h2>Choose a lesson</h2></div><div class="types" id="types"></div></section><section class="step"><div class="step-title"><span class="step-number">2</span><h2>Choose a time</h2></div><p class="muted" id="tz"></p><div class="slots" id="slots"></div></section><form id="booking" class="hidden"><h2>Your details</h2><label>Name<input name="student_name" required maxlength="255"></label><label>Email<input name="student_email" type="email" required maxlength="320"></label><label>Anything I should know?<textarea name="notes" maxlength="2000"></textarea></label><label class="hp">Website<input name="website" tabindex="-1" autocomplete="off"></label><button class="primary">Confirm lesson</button></form><p id="error" class="error"></p></div><div id="success" class="success hidden"></div></main>
<script>
